...
@Component({
  selector: 'app-showfourgestac',
  templateUrl: './showfourgestac.component.html',
  styleUrls: ['./showfourgestac.component.scss']
})
export class ShowfourgestacComponent implements OnInit {
  listefour:any =[];
