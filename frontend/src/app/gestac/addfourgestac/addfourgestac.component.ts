...
@Component({
  selector: 'app-addfourgestac',
  templateUrl: './addfourgestac.component.html',
  styleUrls: ['./addfourgestac.component.scss']
})
export class AddfourgestacComponent implements OnInit {
