...
@Component({
  selector: 'app-modifrecgestac',
  templateUrl: './modifrecgestac.component.html',
  styleUrls: ['./modifrecgestac.component.scss']
})
export class ModifrecgestacComponent implements OnInit {
    ...
    this.reccrud.update(this.currentrec.id, this.modifRec.value)
      .subscribe(
        response => {
          ...
          this.router.navigate(['/Showlistrecgestac']);
